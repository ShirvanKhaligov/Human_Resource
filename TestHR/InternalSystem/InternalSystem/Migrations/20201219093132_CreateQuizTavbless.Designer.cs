...
namespace InternalSystem.Migrations
{
    ...
    [Migration("20201219093132_CreateQuizTavbless")]
    partial class CreateQuizTavbless
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InternalSystem.Areas.InternalHR.Models.Quiz.Answer", b =>
                {
            ...
            modelBuilder.Entity("InternalSystem.Areas.InternalHR.Models.Quiz.Choice", b =>
                {
                    b.Property<int>("ChoiceID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("InternalSystem.Areas.InternalHR.Models.Quiz.Exam_Result", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("GetExamResult");
                });

            modelBuilder.Entity("InternalSystem.Areas.InternalHR.Models.Quiz.Question", b =>
                {
                    b.Property<int>("QuestionID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("InternalSystem.Areas.InternalHR.Models.Quiz.Quiz", b =>
                {
                    b.Property<int>("QuizID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("InternalSystem.Areas.InternalHR.Models.Quiz.Answer", b =>
                {
                    b.HasOne("InternalSystem.Areas.InternalHR.Models.Quiz.Choice", "Choice")
                        .WithMany()
                        .HasForeignKey("ChoiceID");

                    b.HasOne("InternalSystem.Areas.InternalHR.Models.Quiz.Question", "Question")
                        .WithMany("Answers")
                        .HasForeignKey("QuestionID");

                    b.HasOne("InternalSystem.Areas.Admin.Models.AppUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("InternalSystem.Areas.InternalHR.Models.Quiz.Question", b =>
                {
                    b.HasOne("InternalSystem.Areas.InternalHR.Models.Quiz.Quiz", "Quiz")
                        .WithMany("Questions")
