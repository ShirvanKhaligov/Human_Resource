...
namespace InternalSystem.ViewComponents
{
    public class HeaderViewComponent : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            List<Emplooyee> emplooyees = _context.Emplooyeees.Where(e => e.Status != false && e.IsWorking == false&& e.CompanyId==currentUser.CompaniesId && e.IsCandidate == false).ToList();
